...
* The steps of the setup process are:
  ...
  - Installing the AWS CLUI (command line interface)
...
* You are allowed to use a certain amount of AWS resource limits.
...
* Once the user has been created, you should see screen below
  ...
  - Yu don't need to download the .csv file, just click on "Close"
...
* You are now able to do the first lab
