...
* This is an automated test tool writen in Go (the same language Terraform is written in)
...
* As our tests include more an more code, they become longer to execute and more costly to set up and run
