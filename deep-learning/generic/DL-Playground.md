...
<img src="../../assets/images/deep-learning/3rd-party/playground-controls-1.png" alt="playground-controls-1.png" style="background:white;max-width:100%;" width="20%"/><!-- {"left" : 6.97, "top" : 1.22, "height" : 1.63, "width" : 2.54} --><img src="../../assets/images/deep-learning/3rd-party/playground-output-loss-curve.png" alt="playground-output-loss-curve.png" style="background:white;max-width:100%;" width="20%"/><!-- {"left" : 6.15, "top" : 3.43, "height" : 1.29, "width" : 3.86} -->
...
<img src="../../assets/images/deep-learning/3rd-party/playground-controls-1.png" alt="XXX image missing" style="background:white;max-width:100%;" width="20%"/><!-- {"left" : 8.22, "top" : 0.98, "height" : 1.14, "width" : 1.78} -->
<img src="../../assets/images/deep-learning/3rd-party/playground-output-loss-nan.png" alt="XXX image missing" style="background:white;max-width:100%;" width="30%"/><!-- {"left" : 7.22, "top" : 3.28, "height" : 1.37, "width" : 2.77} -->
...
<img src="../../assets/images/deep-learning/3rd-party/playground-dataset-linear-1.png" alt="XXX image missing" style="width:20%;"/><!-- {"left" : 6.43, "top" : 4.17, "height" : 3.34, "width" : 3.25} -->
...
## Linear Classification: Run
  ...
  * Challenge: Adjust the learning rate to get to minimum loss in as few epochs as possible.
  ...
  <img src="../../assets/images/deep-learning/3rd-party/playground-dataset-linear-2.png" alt="XXX image missing" style="width:30%;"/><!-- {"left" : 3.22, "top" : 3.78, "height" : 3.86, "width" : 3.82} -->
...
<img src="../../assets/images/deep-learning/3rd-party/playground-dataset-circle-1.png" alt="playground-dataset-circle-1.png" style="width:25%;"/><!-- {"left" : 0.77, "top" : 1.67, "height" : 3.1, "width" : 3.08} -->
...
<img src="../../assets/images/deep-learning/3rd-party/playground-dataset-circle-1.png" alt="XXX image missing" style="width:30%;"/><!-- {"left" : 3.28, "top" : 4.32, "height" : 3.72, "width" : 3.69} -->
...
<img src="../../assets/images/deep-learning/3rd-party/playground-features-1.png" alt="XXX image missing" style="width:11%;"/><!-- {"left" : 7, "top" : 1.73, "height" : 6.19, "width" : 1.91} -->
...
<img src="../../assets/images/deep-learning/3rd-party/playground-dataset-fourposter-1.png" alt="XXX image missing" style="width:30%;"/><!-- {"left" : 0.77, "top" : 1.62, "height" : 3.58, "width" : 3.59} -->
...
<img src="../../assets/images/deep-learning/3rd-party/playground-dataset-spiral-2.png" alt="XXX image missing" style="width:30%;"/><!-- {"left" : 0.77, "top" : 1.67, "height" : 4.06, "width" : 4.02} -->
...
<img src="../../assets/images/deep-learning/3rd-party/playground-hidden-layer.png" alt="XXX image missing" style="width:40%;"/><!-- {"left" : 2.12, "top" : 3.14, "height" : 4.49, "width" : 6} -->
...
<img src="../../assets/images/deep-learning/3rd-party/playground-dataset-circle-1.png" alt="playground-dataset-circle-1.png" style="max-width:50%;"/><!-- {"left" : 2.52, "top" : 2.2, "height" : 5.24, "width" : 5.21} -->
...
- You can add neurons.
<img src="../../assets/images/deep-learning/3rd-party/playground-hidden-layer.png" alt="playground-hidden-layer.png" style="max-width:50%;float:right;"/><!-- {"left" : 2.33, "top" : 3.31, "height" : 4.18, "width" : 5.59} -->
...
<img src="../../assets/images/deep-learning/3rd-party/playground-dataset-spiral-2.png" alt="playground-dataset-spiral-2.png" style="width:30%;"/><!-- {"left" : 0.77, "top" : 1.65, "height" : 3.1, "width" : 3.07} -->
...
<img src="../../assets/images/deep-learning/3rd-party/playground-dataset-spiral-solution-1.png" alt="playground-dataset-spiral-solution-1.png" style="width:35%;"/><!-- {"left" : 2.94, "top" : 2.05, "height" : 5.55, "width" : 4.37} -->
